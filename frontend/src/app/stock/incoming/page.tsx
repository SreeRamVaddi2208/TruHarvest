...
export default function IncomingShipmentsPage() {
  ...
  const handleSubmit = () => {
    ...
    if (validLines.length === 0) {
      toast.error("Please add at least one line item with a product and quantity.");
      return;
    }
    ...
    createIncoming.mutate(
      ...
      },
      {
        ...
        onError: () => {
          toast.error("Failed to create incoming shipment. Please try again.");
        },
      }
    );
  };
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Receive stock from suppliers into your warehouse
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Fill in the details below to create a new incoming shipment.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="space-y-2">
              <Label htmlFor="partner">Supplier (optional)</Label>
              {partnersLoading ? (
      ...
      {/* Recent Incoming Pickings */}
      <Card>
        <CardHeader>
          <CardTitle>Recent Incoming Shipments</CardTitle>
          <CardDescription>Previously created incoming pickings</CardDescription>
        </CardHeader>
        <CardContent>
          {pickingsLoading ? (
            ...
            <div className="flex h-[100px] items-center justify-center text-muted-foreground">
              No recent incoming shipments found
            </div>
          )}
        </CardContent>
      </Card>
